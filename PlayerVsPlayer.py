...
def play(player1, player2, loopNum, trainNum):
    ...
    while cnt < loopNum:
        ...
        while board.checkWinner() == 0:
            ...
            if player == 0:
                y1 = Default.defaltAlgo(1 if Player1First else 2, board.getBoard())
            elif player == 1:
                y1 = MiniMax.miniMaxAlgo(1 if Player1First else 2, board.getBoard()) 
            elif player == 2:
                y1 = playerQ.findBestMove(board.getBoard())
            ...
            if board.checkWinner() != 0:
                ...
                if player == 0:
                    y2 = Default.defaltAlgo(2 if Player1First else 1, board.getBoard())
                elif player == 1:
                    y2 = MiniMax.miniMaxAlgo(2 if Player1First else 1, board.getBoard()) 
                elif player == 2:
                    y2 = playerQ.findBestMove(board.getBoard())
